...
class Test {
  ...
  void b(int a, int b) { print("b"); }
  // methods with optional positional parameters
  void c([int? optionalA, int? optionalB]) { print("c"); }
  // methods with positional parameters and optional positional parameters
  void d(int a, int b, [int? optionalC, int? optionalD]) { print("d"); }
  // methods with named parameters
  void e({int? namedA, int? namedD}) { print("e"); }
  // methods with positional parameters and named parameters
  void f(int a, int b, {int? namedC, int? namedD}) { print("f"); }
  ...
  void n(Generic<String, int, int> a, int b) { print("b"); }
  // methods with optional positional parameters with generics
  void o([int? optionalA, Generic<String, int, int>? optionalB]) { print("c"); }
  // methods with positional parameters and optional positional parameters with generics
  void p(int a, Generic<String, int, int> b, [int? optionalC, Generic<String, int, int>? optionalD]) { print("d"); }
  // methods with named parameters with generics
  void q({int? namedA, Generic<String, int, int>? namedD}) { print("e"); }
  // methods with positional parameters and named parameters with generics
  void r(int a, Generic<String, int, int> b, {int? namedC, Generic<String, int, int>? namedD}) { print("f"); }
  ...
  // record parameters
  void z((String, int) a) { print("z"); }
  // return record
  (String, int) A() => ("A", 1);
  // record and generic parameters
  void B((String, int) a, [Generic<String, int, int>? optionalB]) { print("B"); }
